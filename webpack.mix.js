...
var third_party_assets = {
  css_js: [
    ...
    { name: 'tui-code-snippet', assets: ['./node_modules/tui-code-snippet/dist/tui-code-snippet.min.js'] },
    {
      ...
      assets: [
        './node_modules/tui-date-picker/dist/tui-date-picker.min.js',
    ...
    { name: 'tui-dom', assets: ['./node_modules/tui-dom/dist/tui-dom.min.js'] },
    {
      ...
      assets: [
        './node_modules/tui-time-picker/dist/tui-time-picker.min.js',
    ...
    {
      name: 'toastr',
      assets: ['./node_modules/toastr/build/toastr.min.js', './node_modules/toastr/build/toastr.min.css'],
    },
    {
      name: 'rwd-table',
      assets: [
    ...
    { name: 'bootstrap-maxlength', assets: ['./node_modules/bootstrap-maxlength/dist/bootstrap-maxlength.min.js'] },
    {
      ...
      assets: [
        './node_modules/bootstrap-rating/bootstrap-rating.min.js',
        './node_modules/bootstrap-rating/bootstrap-rating.css',
      ],
    },
    {
      name: 'dropzone',
    ...
    {
      name: 'dragula',
      assets: ['./node_modules/dragula/dist/dragula.min.js', './node_modules/dragula/dist/dragula.min.css'],
    },
...
mix
  .sass('resources/scss/icons.scss', folder.dist_assets + 'css')
  .options({ processCssUrls: false })
  .minify(folder.dist_assets + 'css/icons.css');
mix
  .sass('resources/scss/app.scss', folder.dist_assets + 'css')
  .options({ processCssUrls: false })
  .minify(folder.dist_assets + 'css/app.css');
...
var app_pages_assets = {
  js: [
    folder.src + 'js/pages/bootstrap-toastr.init.js',
    ...
    folder.src + 'js/pages/candidate-list.init.js',
    ...
    folder.src + 'js/pages/dashboard-job.init.js',
    ...
    folder.src + 'js/pages/job-list.init.js',
