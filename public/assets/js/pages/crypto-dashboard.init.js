...
var walletBalanceColors = getChartColorsArray("wallet-balance-chart");
if (walletBalanceColors) {
  var walletOptions = {
    series: [76, 67, 61],
    chart: {
      height: 302,
...
// Overview chart
var overviewTimelineColors = getChartColorsArray("overview-chart-timeline");
