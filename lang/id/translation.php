...
return [
  ...
  "Cash" => "Kas",
  "Balance" => "Neraca",
  "Salary-Payment" => "Pembayaran Gaji",
  "Debts" => "Hutang",
  "Receivables" => "Piutang",
  "Assets" => "Aset",
  ...
  "Ledger" => "Buku Besar",
  "Initial_Trial_Balance" => "Neraca Saldo Awal",
  "Final_Trial_Balance" => "Neraca Saldo Akhir",
  ...
  "Expert_System_Symptom" => "Data Gejala",
  "Expert_System_PestDisease" => "Data Hama dan Penyakit",
  "Expert_System_RuleBase" => "Rule Base",
