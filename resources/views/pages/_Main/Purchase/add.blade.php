  ...
  <div class="row">
    <div class="col-12">
      ...
      <div class="alert alert-primary" role="alert">
        Anda dapat menambahkan stok produk dengan mengisi form di bawah ini.
        <br />
        <b>Pastikan anda menambahkan stok dengan satu supplier yang sama.</b>
      </div>
    </div> <!-- end col -->
  </div> <!-- end row -->
        ...
        <div class="card border-primary border">
          <div class="card-body">
            ...
            <div class="form-group mb-3">
              ...
              <select class="form-control select2-supplier" id="supplier" name="supplier" style="width: 100%;">
              </select>
            </div>
        ...
        <div class="modal-body">
          <form class="needs-validation" id="form-savePurchase" novalidate>
            ...
            <div class="form-group mb-3">
              ...
              <input class="form-control" id="paymentDate" name="paymentDate" type="date"
                value="{{ date('Y-m-d') }}">
            </div>
            <div class="form-group mb-3">
...
@section('script')
  ...
  <script>
    $('#paymentStatus').on('input', function() {
      if ($(this).val() == 'belum') {
        $('#paymentDateLabel').html('Tanggal Jatuh Tempo');
      } else {
        $('#paymentDateLabel').html('Tanggal Pembayaran');
      }
    });
