            ...
            <div class="row">
              ...
              <div class="col-xl-8 col-md-12">
                <div class="card-body">
                  ...
                  <div id="productDesc" name="productDesc" rows="5">
                    {!! $product->description !!}
                  </div>
              ...
              <div class="col-xl-4 col-md-12">
                <div class="card-body">
                  <div class="form-group mb-0">
                    ...
                    <div class="input-group">
                      <input class="form-control text-start" id="productWeight" type="number"
                        value="{{ $product->weight }}" placeholder="1000">
                  ...
                  <div class="form-group mb-0">
                    ...
                    <div class="input-group">
                      <input class="form-control text-start" id="productDimension" type="text"
                        value="{{ $product->dimension }}" placeholder="100 x 100 x 20">
            ...
            <div class="row">
              ...
              <div class="col-xl-8 col-md-12">
                <div class="card-body">
                  <div class="form-group mb-0">
                    <label>Tags</label>
                    <select class="form-select select2-tags" id="productTags" placeholder="Masukkan tag produk">
                      {{-- data tag is like this: ["ok","yessss"] --}}
              ...
              <div class="col-xl-4 col-md-12">
                <div class="card-body">
                  ...
                  <div class="square-switch mb-2">
                    <input id="isPreorder" type="checkbox" value="{{ $product->is_preorder }}" switch="none">
...
@section('script')
  <script>
    ...
    // set value to select2-shipments
    // value shipments is  like this  ["expedition","pickup"]
    var shipments = {!! json_encode($product->shipment) !!}
    shipments = JSON.parse(shipments);
    shipments.forEach(function(item) {
      var option = new Option(item, item, true, true);
      $('.select2-shipments').append(option).trigger('change');
    });
    ...
    // set value to select2-payments
    // value payments is  like this  ["transfer","cash","qris"]
    var payments = {!! json_encode($product->payment) !!}
    payments = JSON.parse(payments);
    payments.forEach(function(item) {
      var option = new Option(item, item, true, true);
      $('.select2-payments').append(option).trigger('change');
    });
    ...
    var option = new Option(status, status, true, true);
    ...
    // set value to select2-tags
    // value tags is  like this  ["tag1","tag2","tag3"]
    var tags = {!! json_encode($product->tags) !!}
    tags = JSON.parse(tags);
    tags.forEach(function(item) {
      var option = new Option(item, item, true, true);
      $('.select2-tags').append(option).trigger('change');
    });
  </script>
  <script>
  ...
  <script>
    ...
    // set value filepond
    var pathProductImage = document.getElementById("pathProductImage").value
    if (pathProductImage != "") {
      // the value like this : [http://127.0.0.1:8000/images/products/testing/images/1763261762224668.jpg,http://127.0.0.1:8000/images/products/testing/images/1763261762303251.jpg,http://127.0.0.1:8000/images/products/testing/images/1763261764842660.jpg,http://127.0.0.1:8000/images/products/testing/images/1763261764909221.jpg,http://127.0.0.1:8000/images/products/testing/images/1763261767146989.jpg]
      pathProductImage = JSON.parse(pathProductImage)
      document.getElementById("pathProductImage").value = "";
      pathProductImage.forEach(function(item) {
        productImagePond.addFile(item);
      });
  ...
  <script>
    ...
    // set value to isPreorder checkbox
    var isPreorder = document.getElementById("isPreorder").value
    if (isPreorder == 1) {
      $('#isPreorder').prop('checked', true);
      $('#preorderDate').show();
    } else {
      $('#isPreorder').prop('checked', false);
      $('#preorderDate').hide();
    }
