...
<div class="modal fade" id="addVoucherModal" role="dialog" aria-labelledby="verifyModalContent" aria-hidden="true"
  tabindex="-1">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="needs-validation" id="addVoucherForm" novalidate>
          ...
          <div class="d-flex justify-content-end">
            <button class="btn btn-primary addVoucher mt-2" type="submit">
