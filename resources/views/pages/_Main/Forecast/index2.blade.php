...
@section('content')
  ...
  <div class="offcanvas offcanvas-end" id="offcanvasWithBothOptions" data-bs-scroll="true"
    ...
    <div class="offcanvas-body">
      ...
      <div class="bg-secondary bg-soft mt-2 rounded p-2">
        ...
        <p>Fitur forecasting dapat <span class="fw-bold">memberikan acuan jumlah produksi</span> untuk periode berikutnya
          ...
          memproses data
          penjualan sebelumnya kedalam perhitungan forecating menggunakan metode Triple Exponential Smoothing</p>
        <p>
      </div>

      <div class="bg-secondary bg-soft my-2 rounded p-2">
  ...
  <div class="left d-flex align-items-center my-4">
          ...
          <div class="row">
            <div class="col-7">
              <div class="text-primary p-3">
                <h5 class="text-primary">Forecating</h5>
        ...
        <div class="card-body">
          <form class="needs-validation" id="formForecast" novalidate>
            ...
            <div class="mb-1">
              ...
              <input class="form-control" id="alpha" name="alpha" type="number" value="0.7981529" required>
              <div class="valid-feedback">
                Looks good!
              </div>
            </div>
            ...
            <div class="card-body">
              <div class="d-flex">
                <div class="flex-grow-1">
                  <p class="text-muted fw-medium" id="productName">- Terjual</p>
                  <h4 class="mb-0" id="countOrder">-</h4>
                </div>
          ...
          <div class="card mini-stats-wid">
            <div class="card-body">
              <div class="d-flex align-items-center mb-3">
                ...
                <p class="text-muted fw-medium m-0" id="productName2">Daerah dengan penjualan -
                  terbanyak</p>
              </div>
...
@section('script')
  ...
  <script>
    // if session has flash message then show toast
    @if (isset($error))
      toastError('{!! $error !!}');
      // console.log('error');
    @endif
  ...
  <script>
    ...
    $('#submitForecast').on('click', function(e) {
      ...
      if ($('#formForecast').parsley().validate()) {
        $('#forecast_result').html('');
        $('#forecast_chart').html('');
        //  show error message
        toastWarning('Silahkan lengkapi form terlebih dahulu');
        return false;
      }
