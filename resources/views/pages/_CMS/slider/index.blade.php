      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="card-title">
            <h4>Desktop Slider</h4>
            <div class="d-flex justify-content-end">
              <button class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal"
                data-bs-target="#addUserModal" type="button">
                <i class="bx bx-user-plus font-size-16 me-2 align-middle"></i> Tambah Slider
              </button>
            </div>
          </div>

          <div id="table">
            <table class="table-bordered dt-responsive nowrap w-100 table" id="tbl-slider-desktop">
              <thead>
                <tr>
                  <th>Urutan</th>
                  <th>Title</th>
              ...
              <tbody>
                @foreach ($sliders as $item)
                  <tr>
                    ...
                    <td>{{ $item->title }}</td>
                    <td>{{ $item->image }}</td>
                    <td><span class="badge bg-primary p-2">{{ $item->status }}</span></td>
                    <td>
                      <button class="btn btn-warning waves-effect waves-light btn-sm" type="button"
                        onclick="editOrder('{{ $item->id }}')">
                        <i class="bx bx-edit"></i> Ubah Urutan
                      </button>

                      <button class="btn btn-warning waves-effect waves-light btn-sm" type="button"
                        onclick="editSlider('{{ $item->id }}')">
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-body">
          ...
          <div id="table">
            <table class="table-bordered dt-responsive nowrap w-100 table" id="tbl-slider-mobile">
              <thead>
                <tr>
                  <th>Urutan</th>
                  <th>Title</th>
...
@section('script')
  ...
  <!-- Datatable init -->
  <script>
    dataTableInit('#tbl-slider-desktop');
    dataTableInit('#tbl-slider-mobile');
    $('.select2').select2();
  </script>
